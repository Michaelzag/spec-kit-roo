...
#     AGENTS  : space or comma separated subset of: claude gemini copilot cursor roo (default: all)
...
build_variant() {
  ...
  case $agent in
    ...
    roo)
      ...
      [[ -f AGENTS.md ]] && cp AGENTS.md "$base_dir/AGENTS.md"
      ;;
  esac
...
ALL_AGENTS=(claude gemini copilot cursor roo)
ALL_SCRIPTS=(sh ps)
